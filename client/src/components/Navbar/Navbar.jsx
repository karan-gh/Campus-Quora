  ...
  return (
    <nav className='main-nav'>
        <div className="navbar">
            ...
            <a href="https://github.com/karan-gh/Campus-StackExchange" className='nav-item nav-btn' rel="noreferrer" target='_blank'>Github</a>
            <a href="https://www.linkedin.com/in/karan-rabidas-01a94b240/" className='nav-item nav-btn' rel="noreferrer" target='_blank'>About Developer</a>
